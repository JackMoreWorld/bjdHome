...
public class HttpClientUtils {
	...
	public static String post(String url, String body, String mimeType, String charset, Integer connTimeout,
		...
		String result = "";
		try {
			if (!BgdStringUtil.isNullOrEmpty(body)) {
	 ...
	 * post("https://localhost:443/ssl/test.shtml","name=12&page=34",
	 * "application/x-www-form-urlencoded", "UTF-8", 10000, 10000); //String str=
	 ...
	 * System.out.println(str); } catch (ConnectTimeoutException e) {
